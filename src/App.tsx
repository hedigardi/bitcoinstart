...
import { whatWeHelpWith } from "./data";
        ...
        <section className="bg-white dark:bg-slate-950 py-16 border-b border-slate-100 dark:border-slate-800">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
               ...
               >
                 Understanding Bitcoin should not feel confusing
               </motion.h2>
               <p className="mt-4 text-lg text-slate-600 dark:text-slate-400">
                 We bridge the gap between technical complexity and practical understanding.
               </p>
            </div>
