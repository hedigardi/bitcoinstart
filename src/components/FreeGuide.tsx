        ...
        <div className="grid gap-16 lg:grid-cols-[1.3fr_0.9fr] lg:items-center">
          ...
          >
            ...
            <p className="mt-6 text-lg leading-8 text-slate-700 dark:text-slate-300">
              Curious about Bitcoin but not sure where to start? Download our short and practical guide for beginners who want a clearer and safer introduction.
            </p>
          ...
          >
            <h3 className="text-xl font-semibold text-slate-950 dark:text-white">Get the free guide</h3>
            <p className="mt-3 text-slate-600 dark:text-slate-400">Enter your email to receive the PDF.</p>
            <form className="mt-8 space-y-4" onSubmit={(e) => e.preventDefault()}>
              <input
                type="text"
                placeholder="Your name"
                className="w-full rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-4 py-3 text-slate-900 dark:text-white outline-none transition-all focus:border-orange-400 focus:ring-4 focus:ring-orange-400/10 dark:focus:ring-orange-500/5 placeholder:text-slate-400"
              />
              <input
                type="email"
              ...
              <button
                type="submit"
                className="w-full rounded-2xl bg-orange-600 px-5 py-4 text-sm font-bold text-white transition hover:bg-orange-700 shadow-lg shadow-orange-900/10 dark:shadow-none active:scale-[0.98]"
              >
                Download Guide
              </button>
            </form>
