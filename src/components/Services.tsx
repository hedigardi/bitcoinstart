...
export default function Services() {
  return (
    <section id="services" className="border-y border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50 transition-colors duration-300">
      <div className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
        <div className="max-w-3xl">
          <h2 className="text-3xl font-semibold tracking-tight text-slate-950 dark:text-white">Our Services</h2>
          <p className="mt-4 text-lg leading-8 text-slate-600 dark:text-slate-400">
            We offer simple and practical sessions designed to help you understand Bitcoin more clearly and take better next steps.
          </p>
        </div>
        ...
        <div className="mt-12 grid gap-8 md:grid-cols-2 xl:grid-cols-3">
          {services.map((service, index) => (
            ...
            >
              ...
              <p className="mt-4 leading-7 text-slate-600 dark:text-slate-400">{service.description}</p>
              ...
              <div className="mt-8 border-t border-slate-100 dark:border-slate-800 pt-6 space-y-3 text-sm text-slate-600 dark:text-slate-400">
                <div className="flex justify-between">
                  ...
                  <span className="text-slate-900 dark:text-slate-200">{service.format}</span>
                </div>
                <div className="flex justify-between">
                  <span className="font-medium text-slate-500">Duration</span>
                  <span className="text-slate-900 dark:text-slate-200">{service.duration}</span>
                </div>
                <div className="flex justify-between">
                  <span className="font-medium text-slate-500">Price</span>
                  <span className="font-semibold text-slate-900 dark:text-white">{service.price}</span>
                </div>
              </div>
