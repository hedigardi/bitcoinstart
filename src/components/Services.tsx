...
import { BadgeCheck, BookOpenText, CheckSquare, Users } from "lucide-react";
        ...
        <div className="mt-12 space-y-8">
          {services.map((service, index) => (
            <motion.div
              ...
              className="rounded-3xl bg-white dark:bg-slate-950 p-8 shadow-sm ring-1 ring-slate-100 dark:ring-slate-800 transition-all hover:shadow-xl dark:hover:shadow-orange-900/20 hover:ring-orange-200 dark:hover:ring-orange-900/50"
            >
              <div>
